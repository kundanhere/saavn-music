    ...
    <div className={cn('space-y-3', className)} style={{ maxWidth: `${size}px` }} {...props}>
      ...
      <div className="flex flex-col space-y-1 text-xs">
        ...
        <h5
          ...
          className="inline-block origin-left scale-90 truncate text-[0.5rem] tracking-tight text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
        >
          {media.album?.name
